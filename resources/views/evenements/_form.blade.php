...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div>
        ...
        <x-date-input name="date_debut" :value="old('date_debut', $evenement?->date_debut?->format('Y-m-d') ?? now()->format('Y-m-d'))" required />
    ...
    <div>
        ...
        <x-date-input name="date_fin" :value="old('date_fin', $evenement?->date_fin?->format('Y-m-d'))" />
